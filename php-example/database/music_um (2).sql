...
(1, 1, 1, 'Great insights into the indie music scene! Really enjoyed reading this.', '2025-03-04 12:02:24'),
(2, 2, 2, 'Top 10 list is spot on! Can’t wait to check out some of these albums.', '2025-03-04 12:02:24'),
(3, 3, 3, 'AI in music production is a game changer. Thanks for sharing this information.', '2025-03-04 12:02:24');
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `role`, `created_on`) VALUES
(1, 'Urik', 'urik@gmail.com', '$2y$10$o3zJJRcqXSxiw6UU5vpP1eBgQ4zeSr4smCfCcaAK/28okDTul7jem', 'user', '2025-02-18 12:53:07'),
(2, 'Koval', 'koval@gmail.com', '$2y$10$VW24TAu0NAMml7Wrbf0Y4.cjVSkslAqm1vXJcE.E0iVBggCc8LWC.', 'user', '2025-02-18 13:33:39'),
(3, 'Anna', 'anna@gmail.com', '$2y$10$2Mx2ALxdc2tk3s1bM3dategWfnES4uDbf7KDpGmF8q0Vwc85lc1Ta', 'user', '2025-02-18 13:12:32'),
(4, 'Edward', 'edward@gmail.com', '$2y$10$toUUM0FBN9GF/NloSNyflutF9Oq24V97aMUbnPMYvUCy9nsycxHcC', 'user', '2025-02-18 13:44:33'),
(5, 'Yarchyk', 'yarchyk@gmail.com', '$2y$10$aE7/eyBlqB81iS6nqyJZh.eYWDkWw0gSXYhHug.VSBixsosqgxHki', 'user', '2025-02-18 13:54:02');
