<footer class="bg-gray-900 text-gray-300 py-6 px-16 font-sans tracking-wide relative z-20">
      <div class="flex justify-between items-center max-lg:flex-col text-center flex-wrap gap-4">
        ...
        <ul class="flex space-x-6 gap-y-2 max-lg:justify-center flex-wrap">
          ...
          <li><a href="contact" class="text-[15px] hover:text-white">Contact Us</a></li>
        </ul>
      </div>
    </footer>
