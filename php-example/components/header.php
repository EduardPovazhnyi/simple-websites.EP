        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class='max-lg:border-b max-lg:py-3 px-3'>
              <a href='home' class='text-gray-300 hover:text-white text-base flex items-center'>
            ...
            <li class='max-lg:border-b max-lg:py-3 px-3'>
              <a href='blog_list' class='text-gray-300 hover:text-white text-base flex items-center'>
            ...
            <?php if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) : ?>
              <?php if($_SESSION['role'] === 'admin') : ?>
                ...
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='pending' class='text-gray-300 hover:text-white text-base flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4 mr-3" viewBox="0 0 512 512">
                      <path
                        d="M337.711 241.3a16 16 0 0 0-11.461 3.988c-18.739 16.561-43.688 25.682-70.25 25.682s-51.511-9.121-70.25-25.683a16.007 16.007 0 0 0-11.461-3.988c-78.926 4.274-140.752 63.672-140.752 135.224v107.152C33.537 499.293 46.9 512 63.332 512h385.336c16.429 0 29.8-12.707 29.8-28.325V376.523c-.005-71.552-61.831-130.95-140.757-135.223zM446.463 480H65.537V376.523c0-52.739 45.359-96.888 104.351-102.8C193.75 292.63 224.055 302.97 256 302.97s62.25-10.34 86.112-29.245c58.992 5.91 104.351 50.059 104.351 102.8zM256 234.375a117.188 117.188 0 1 0-117.188-117.187A117.32 117.32 0 0 0 256 234.375zM256 32a85.188 85.188 0 1 1-85.188 85.188A85.284 85.284 0 0 1 256 32z"
                        data-original="#000000"></path>
                ...
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='add_blog' class='text-gray-300 hover:text-white text-base flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4 mr-3" viewBox="0 0 512 512">
                      <path
                        d="M337.711 241.3a16 16 0 0 0-11.461 3.988c-18.739 16.561-43.688 25.682-70.25 25.682s-51.511-9.121-70.25-25.683a16.007 16.007 0 0 0-11.461-3.988c-78.926 4.274-140.752 63.672-140.752 135.224v107.152C33.537 499.293 46.9 512 63.332 512h385.336c16.429 0 29.8-12.707 29.8-28.325V376.523c-.005-71.552-61.831-130.95-140.757-135.223zM446.463 480H65.537V376.523c0-52.739 45.359-96.888 104.351-102.8C193.75 292.63 224.055 302.97 256 302.97s62.25-10.34 86.112-29.245c58.992 5.91 104.351 50.059 104.351 102.8zM256 234.375a117.188 117.188 0 1 0-117.188-117.187A117.32 117.32 0 0 0 256 234.375zM256 32a85.188 85.188 0 1 1-85.188 85.188A85.284 85.284 0 0 1 256 32z"
                        data-original="#000000"></path>
                ...
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='user_profile' class='text-gray-300 hover:text-white text-base flex items-center'>
            ...
            <?php endif ?>
            <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='logout' class='text-gray-300 hover:text-white text-base flex items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" class="w-4 h-4 mr-3"
                      viewBox="0 0 682.667 682.667">
                      <defs>
                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
